          ...
          <div className="w-full sm:w-[80%] lg:w-[70%] border-4 border-[#400] grid place-items-center p-4 sm:p-2">
            <div className="border-2 border-[#400] w-full grid place-items-center gap-4 text-center p-4">
              <div className="w-3/4 sm:w-2/4 lg:w-1/3">
                <img src="assets/image/navAnimatedImg.svg" className="w-full" />
              </div>
              <div className="border-t border-b border-[#400] w-1/2 py-2">
                <span>P A R T Y MENU 1</span>
              </div>
              <div>
                <h2 className="text-2xl sm:text-3xl font-bold">APPETIZERS</h2>
                <span className="text-lg sm:text-xl">choice of</span>
              </div>
              <div className="pt-4 sm:pt-8 grid gap-2">
                <h4>*GEORGE HOUSE SALAD</h4>
                <span>mixed greens, tomatoes, house dressing</span>
                <span>*MEATBALLS</span>
                <span>Braised meatballs, parmesan cheese,</span>
                <span>tomato basil sauce </span>
                <h2 className="text-2xl sm:text-3xl font-bold">ENTREES</h2>
                <span className="text-lg sm:text-xl">choice of</span>
              </div>
