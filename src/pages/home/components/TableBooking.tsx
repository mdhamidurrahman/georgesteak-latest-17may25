...
const TableBooking = () => {
  return (
    <div className="pt-[350px] bg-transparent font-light flex justify-center items-center flex-col">
      ...
      <div className="flex justify-center py-[800px] items-center text-center">
      <img className=" h-[60px] w-[70px] " src="https://georgesteakhouse.com/images/adacompliancelogo_2x69x57.png?crc=3880310862" alt="img" />
      </div>
    </div>
  );
};
